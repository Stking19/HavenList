        ...
        <div className='email-card'>
            ...
            <div className='innerbody-cont'>
                ...
                <div className='emailwriteup-cont'>
                    <p>We have sent an email to <span>onuohajoshua555@gmail.com</span> to confirm the validity </p>
                    <p>of our email address. After recieving the email follow the link provided</p>
