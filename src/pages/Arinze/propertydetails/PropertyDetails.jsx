  ...
  return (
    <>
      <div className='propertyDetailMain'>
        <div className='propertyDetailWrapper'>
          ...
          <nav>
            ...
            <h3>{productD.area},{productD.state}</h3>
            <p>{productD.bedrooms} Bedrooms, {productD.bathrooms} Bathrooms , {productD.toilets} Toilets</p>
          </nav>

          <p>Hosted by HavenList Homes</p>

          <span className='aboutTexts' style={{display:'flex',flexDirection:'column',gap:'10px'}}>
      ...
      <div className='modalpropertyDetailCard'>
        <h2>N{productD.price}<small>per Annum</small></h2>
